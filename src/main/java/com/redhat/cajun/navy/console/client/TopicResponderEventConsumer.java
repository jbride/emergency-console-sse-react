...
@ApplicationScoped
public class TopicResponderEventConsumer {

    private static Logger log = Logger.getLogger(TopicResponderEventConsumer.class);
    ...
    @Incoming("topic-responder-event")
    ...
    @Incoming("responder-update-stream")
